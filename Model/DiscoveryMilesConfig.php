...
/**
 * Class DiscoveryMilesConfig
 *
 * Discovery Miles payment method configuration provider
 */
class DiscoveryMilesConfig implements ConfigProviderInterface
{
    const CODE = DiscoveryMiles::CODE;
    ...
    {
        return $this->assetRepo->getUrl( 'PayU_EasyPlus::images/discoverymiles_2016.jpg');
    }
}
